...
__global__ void prodottoScalareGPU(float* a, float* b, float* v, int n);
...
int main(void){
    ...
    printf("***\t prodotto scalare prima strategia \t***\n");
    ...
    prodottoScalareGPU<<<gridDim, blockDim>>>(a_d, b_d, v_d, N);
